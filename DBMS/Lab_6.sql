...
SELECT SIN(4.2014),TAN(4.2014),COS(4.2014)
...
SELECT FIRSTNAME + 'LIVE IN' + CITY FROM STUDENT

--8. Combine the result as Student_ID of < FirstName > is <StuID> .
SELECT 'STUDENT_ID' + 'OF' + FIRSTNAME + 'IS' + STUID FROM STUDENT
...
SELECT DATEADD(YYYY,5,JOININGDATE) FROM EMP_DETAIL

--3. Write a query to subtract 2 months from JoiningDate.
SELECT DATEADD(MM,-2,JOININGDATE) FROM EMP_DETAIL

--4. Extract month from JoiningDate using datename () and datepart () function.
SELECT DATENAME(MONTH,JOININGDATE),DATEPART(MM,JOININGDATE) FROM EMP_DETAIL

--5. Calculate your age in years and monthsSELECT DATEDIFF(YEAR,2005-03-27,GETDATE()) AS YEAR , DATEDIFF(MONTH,2005-03-27,GETDATE()) AS MONTH, DATEDIFF(DAY,2005-03-27,GETDATE()) AS DAY